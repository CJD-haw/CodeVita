...
Write a code to calculate earnings in a day for which one array/
List of values representing age of patients visited on that day is passed as input.
...
Note:
    Input and Output Format should be same as given in the above example.
